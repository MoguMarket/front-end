...
import AddSalesAI from "./pages/sellerPage/add-sales-ai.jsx";
import SellerMyPage from "./pages/sellerPage/seller-mypage.jsx";
    ...
    <div className="relative w-full max-w-[390px] mx-auto bg-white">
      ...
      >
        <Routes>
          ...
          <Route path="/seller/add-sales-ai" element={<AddSalesAI />} />{" "}
          {/* ✅ 추가 */}
          {/* 셀프바이 */}
          <Route
